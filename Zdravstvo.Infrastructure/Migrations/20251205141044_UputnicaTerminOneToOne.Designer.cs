...
namespace Zdravstvo.Infrastructure.Migrations
{
    ...
    [Migration("20251205141044_UputnicaTerminOneToOne")]
    partial class UputnicaTerminOneToOne
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Zdravstvo.Core.Entities.Termin", b =>
                {
                    ...
                    b.HasIndex("UputnicaId")
                        .IsUnique()
                        .HasFilter("[UputnicaId] IS NOT NULL");
            ...
            modelBuilder.Entity("Zdravstvo.Core.Entities.Pregled", b =>
                {
                    ...
                    b.HasOne("Zdravstvo.Core.Entities.Termin", "Termin")
                        .WithOne("Pregled")
                        .HasForeignKey("Zdravstvo.Core.Entities.Pregled", "TerminId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Zdravstvo.Core.Entities.Termin", b =>
                {
                    ...
                    b.HasOne("Zdravstvo.Core.Entities.Uputnica", "Uputnica")
                        .WithOne()
                        .HasForeignKey("Zdravstvo.Core.Entities.Termin", "UputnicaId")
                        .OnDelete(DeleteBehavior.Restrict);
